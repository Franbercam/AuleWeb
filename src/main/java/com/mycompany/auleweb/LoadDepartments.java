 ...
 * @author ldrak
 */
@WebServlet(name = "LoadDepartments", urlPatterns = {"/LoadDepartments"})
public class LoadDepartments extends HttpServlet {
            ...
            try {
                ...
                for (FileItem item : items) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        new SQLConstructor().readDataDepartments(uploadedFile);
